...
\lstinline|Collector| para auxiliar no desenvolvedor. No caso exemplificado foi
...
\begin{figure}[h]
  \centering
    ...
    \caption{Diagrama de sequência da instanciação de um \lstinline|Parser| os efeitos na \lstinline|CollectorFactory|}
...
traz consigo outros dois objetos importantes em sua formação: uma instancia de um
