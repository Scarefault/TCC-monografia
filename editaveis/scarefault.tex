...
O \scarefault contempla a linguagem Grails até o momento. Para facilitar a compilação do \scarefault, criou-se um \textit{makefile} responsável por  
% cria o parser/gramática usando guias (mai detlhes no cap de resultados)
% Falar do make que automatiza o processo de build com make clean
% 
