...
\subsubsection{Classificação por Conhecimento Embutido}
\begin{description}
\item[Framework de Horizontal:]
\item[Framework de Vertical:]
\end{description}
% Geração de Testes
% Resumo do Capítulo