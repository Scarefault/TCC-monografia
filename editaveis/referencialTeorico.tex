...
Com o tempo algumas estruturas utilizadas para solucionar determinados problemas, e que respeitavam os princípios descritos acima, foram sendo repetidas. A essas estruturas foi dado o nome de \textit{design patterns}. \textit{Design pattern}, de uma maneira simplista, é definido, segundo \citeonline{martin2000}, como \textit{" a well worn and known good solution to
