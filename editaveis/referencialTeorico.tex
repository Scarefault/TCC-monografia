...
\end{description}
\par
\indent Utilizando-se de um gráfico de fluxo de controle fica mais fácil a visualização e identificação dos caminhos a serem testados \cite{copeland2003}.
