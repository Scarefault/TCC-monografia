...
%\citeonline{sommerville2007}, verificação e validação de software é o processo
...
%do software, de forma a garantir que o produto respeita o especificado desde o
...
na Figura \ref{fig:bibFrameworkPattern}, biliotecas de classes possuem
...
de uma maneira simplista, são definidos, segundo \citeonline{martin2000}, como
...
\citeonline{gammaEtAl1994}, \textit{design pattern} é uma solução simples e
...
As desvantagens em um \textit{framework} concentram-se no período de
...
Essa classificação é usada para demonstrar como o conhecimento de domínio está
