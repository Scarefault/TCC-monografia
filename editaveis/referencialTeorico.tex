...
\begin{figure}[h]
  \begin{center}
    \includegraphics[width=\textwidth]{figuras/test_black_box.eps}
    \caption{Diagrama Representativo de Testes Caixa Preta}
    \label{test_black_box}
  \end{center}
\end{figure}

A Figura \ref{test_black_box} representa um esquemático do funcionamento de um teste caixa-preta: utiliza-se dados de entrada no software e observa-se se correspondem com as expectativas.
